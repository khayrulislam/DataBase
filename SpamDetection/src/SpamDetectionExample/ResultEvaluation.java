...
public class ResultEvaluation {
	...
	private ArrayList<Integer> testAsnwer = new ArrayList<Integer>();
	private ArrayList<Integer> originalAsnwer = new ArrayList<Integer>();
	
	private double accuracy,truePositive,trueNegative,falsePositive,falseNegative,precision,recall,f1score,totalPositive,totalNegative;
	
	public ResultEvaluation(ArrayList<Integer> testAsnwer,ArrayList<Integer> originalAsnwer) {
